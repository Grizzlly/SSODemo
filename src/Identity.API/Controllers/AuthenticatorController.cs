...
public sealed class AuthenticatorController : ControllerBase
{
    ...
    private async Task<(string, string)> LoadSharedKeyAndQrCodeUriAsync(ApplicationUser user)
    {
        ...
        (string, string) sharedKeyAndQrCode = (FormatKey(unformattedKey ?? string.Empty), GenerateQrCodeUri(email ?? string.Empty, unformattedKey ?? string.Empty));
    ...
    private string GenerateQrCodeUri(string email, string unformattedKey)
    {
        return string.Format(
            ...
            AuthenticatorUriFormat ?? string.Empty,
            urlEncoder.Encode("Grizzlly-Identity"),
