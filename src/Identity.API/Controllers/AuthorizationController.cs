...
public class AuthorizationController : Controller
{
    ...
    public async Task<IActionResult> Authorize()
    {
        ...
        var authorizations = _authorizationManager.FindAsync(
            ...
            scopes: request.GetScopes()).ToBlockingEnumerable();
    ...
    public async Task<IActionResult> Exchange()
    {
        ...
        else if (request.IsClientCredentialsGrantType())
        {
            ...
            identity.SetClaim(Claims.Name, await _applicationManager.GetDisplayNameAsync(application ?? string.Empty));
    ...
    /// <returns></returns>
    public virtual async Task AddUserClaimsAsync(ClaimsIdentity claimsIdentity, ApplicationUser user)
    {
        ...
        {
            var role = await _roleManager.FindByNameAsync(roleName: assignedRole);
