...
public sealed class AccountController : ControllerBase
{
    ...
    public async Task<IActionResult> ChangePassword([FromBody] ChangePasswordModel model)
    {
        if (ModelState.IsValid)
        {
            ...
            {
                return BadRequest(new BadRequestResponse(changePasswordResult.Errors.Select(e => e.ToString() ?? string.Empty)));
            }
    ...
    public async Task<IActionResult> SetPassword([FromBody] SetPasswordModel model)
    {
        if (ModelState.IsValid)
        {
            ...
            {
                return BadRequest(new BadRequestResponse(addPasswordResult.Errors.Select(e => e.ToString() ?? string.Empty)));
            }
