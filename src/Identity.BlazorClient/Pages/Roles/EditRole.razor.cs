...
using Company.WebApps.Identity.BlazorClient.Components;
...
public partial class EditRole : ComponentBase
{
    ...
    [Inject]
    public IUserRolesService UserRoleService { get; set; } = default!;

    [Inject]
    public IRoleClaimsService RoleClaimsService { get; set; } = default!;
    ...
    {
        model = await GetRoleDetailsAsync(Id);
