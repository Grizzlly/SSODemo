...
public class AccountService : IAccountService
{
    ...
    {
        var result = await httpClient.PostAsJsonAsync($"api/account/password/change", model);
    ...
    {
        var result = await httpClient.PostAsJsonAsync($"api/account/password/set", model);
        return await OperationResult.FromResponseAsync(result);
    }
    ...
    {
        var result = await httpClient.PostAsJsonAsync($"api/account/email/change", model);
        return await OperationResult.FromResponseAsync(result);
    }
    ...
    {
        var result = await httpClient.PostAsJsonAsync($"api/account/email/resendconfirm", model);
        return await OperationResult.FromResponseAsync(result);
    }
    ...
    {
        var result = await httpClient.PostAsJsonAsync($"api/account/password/sendresetlink", model);
        return await OperationResult.FromResponseAsync(result);
    }
    ...
    {
        var result = await httpClient.PostAsJsonAsync($"api/account/delete", model);
        return await OperationResult.FromResponseAsync(result);
    }
}
