...
namespace Company.WebApps.Identity.BlazorClient.Services
{
    ...
    public class ApplicationService : IApplicationService
    {
        ...
        public async Task<PagedList<ApplicationViewModel>?> GetApplicationsAsync(GetApplicationsRequest request)
        {
            ...
            return await httpClient.GetFromJsonAsync<PagedList<ApplicationViewModel>>(QueryHelpers.AddQueryString("api/applications", queryStringParam));
        }
        ...
        {
            var result = await httpClient.PostAsJsonAsync("api/applications", applicationDescriptor);
        ...
        {
            var result = await httpClient.PutAsJsonAsync("api/applications", applicationDescriptor);
            return await OperationResult.FromResponseAsync(result);
        }
